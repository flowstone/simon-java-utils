...
public class GoogleTranslateUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GT g = GT.getInstance();
        System.out.println(g.translateText("今天天气不错", "zh_cn", "en"));
        //System.out.println( g.translateText("Hello","en","zh_cn"));
    }
}
...
class GT {
    ...
    public String translateText(String text, String sourceLang, String targetLang) throws Exception {
        ...
        String resp = postHttp(finalPath, nvps);
        if (null == resp) {
        ...
        return jsonObject.getJSONArray(0).getJSONArray(0).get(0).toString();
    }
