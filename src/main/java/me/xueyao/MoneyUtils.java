...
public class MoneyUtils {
	 ...
	 */
	  ...
	  * 汉语中货币单位大写
	  */
	 private static final String[] CN_UPPER_MONENY_UNIT = { "分", "角", "元","拾", "佰", "仟", "万", "拾",
		 													  "佰", "仟", "亿", "拾", "佰", "仟", "兆", "拾",
		 													  "佰", "仟" };
	 /**
	  * 特殊字符：整
        ...
        while (true) {
            ...
            if (numUnit > 0) {
                if ((numIndex == 9) && (zeroSize >= 3)) {
                    sb.insert(0, CN_UPPER_MONENY_UNIT[6]);
                }
                if ((numIndex == 13) && (zeroSize >= 3)) {
                    sb.insert(0, CN_UPPER_MONENY_UNIT[10]);
                }
                sb.insert(0, CN_UPPER_MONENY_UNIT[numIndex]);
